...
> The included `train_loan_data.csv` is a sample dataset matching this structure. Replace it with your own data (same column names) to train on real-world records.
